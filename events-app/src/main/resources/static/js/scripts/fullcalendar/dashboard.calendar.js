        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            events: {
                ...
                success: function() {
                    ...
                    dashboard.department.clearTable();
                    dashboard.course.clearTable();
                    dashboard.sevents.clearTable();
                    dashboard.staffmembers.clearTable();
                    dashboard.classroom.clearTable();
                    departments_report = [];
                    courses_report = [];
                    events_report = [];
                    staff_report = [];
      ...
      let tooltip = '<div class="tooltipevent" style="width:auto;height:20px;vertical-align:middle;background:white;position:absolute;z-index:10001;">'
        ...
        if (calEvent.event._def.extendedProps.type === 'lecture') {
            if (calEvent.event._def.extendedProps.repeat === 'onetime') {
                tooltip = tooltip + '<div><b>\'Έκτακτη Διάλεξη Μαθήματος</b></div>';
            }
            else {
