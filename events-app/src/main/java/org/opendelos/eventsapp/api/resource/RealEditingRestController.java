package org.opendelos.eventsapp.api.resource;
...
import org.opendelos.eventsapp.services.resource.RealEditingFutureService;
import org.opendelos.eventsapp.services.resource.RealEditingToolkit;
...
public class RealEditingRestController {
	...
	public @ResponseBody String doRealEditing (HttpServletRequest request, @PathVariable String rid) {
	...
	public @ResponseBody String cancelRealEditing () {
	...
	public @ResponseBody String approveRealEditing (@PathVariable String rid) {
	...
	public @ResponseBody String rejectRealEditing (@PathVariable String rid) {
