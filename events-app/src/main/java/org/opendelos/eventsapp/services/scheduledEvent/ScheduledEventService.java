package org.opendelos.eventsapp.services.scheduledEvent;
...
public class ScheduledEventService {
    ...
    public void findAndUpdate(ScheduledEvent scheduledEvent) {
        try {
            scheduledEventRepository.save(scheduledEvent);
            long updateResourcesScheduledEvent = scheduledEventRepository.updateResourcesScheduledEvent(scheduledEvent);
