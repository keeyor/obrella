(function () {
    'use strict';
        ...
        $('#about_modal').on('show.coreui.modal', function (e) {
            loadHTMLBySiteAndCodeFromDB("vod","about");
        });
        $('#terms_modal').on('show.coreui.modal', function (e) {
            loadHTMLBySiteAndCodeFromDB("vod","terms");
        });
        $('#faq_modal').on('show.coreui.modal', function (e) {
            loadHTMLBySiteAndCodeFromDB("vod","faq");
        });
        ...
        function loadHTMLBySiteAndCodeFromDB(site, code) {
            ...
            $.ajax({
                type:        "GET",
                url: 		  _location + '/apiw/v1/text/' + site + '/code/' + code,
