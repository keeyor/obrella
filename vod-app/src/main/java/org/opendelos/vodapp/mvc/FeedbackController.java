...
import org.opendelos.vodapp.services.system.FeedbackService;
...
public class FeedbackController {
	...
	public String GetCommentsForm(final Model model,@RequestParam(value = "id",  required = false) String id, Locale locale, HttpServletRequest request) {
