/* 
     ...
     live
*/
package org.opendelos.vodapp.services.scheduler;
...
public class SchedulerUpdateAspects {
	...
	@Pointcut("execution(* org.opendelos.vodapp.services.scheduler.ScheduleService.create(..))  && " +  "args(schedule)")
	public void AfterNewScheduleCreated(Schedule schedule){ }

	@Pointcut("execution(* org.opendelos.vodapp.services.scheduler.ScheduleService.update(..))  && " +  "args(schedule)")
	public void AfterSchedulerUpdated(Schedule schedule){ }

	@Pointcut("execution(* org.opendelos.vodapp.services.scheduler.ScheduleService.delete(..))  && " +  "args(id)")
	public void AfterSchedulerDeleted(String id){ }

	@Pointcut("execution(* org.opendelos.vodapp.services.structure.ClassroomService.findAndUpdate(..))  && " +  "args(classroom)")
	public void AfterClassroomUpdated(Classroom classroom){ }

	/* Institution CalendarUpdates */

	@Pointcut("execution(* org.opendelos.vodapp.services.structure.InstitutionService.saveCustomPause(..))")
	public void AfterInstitutionPauseUpdated(){ }

	@Pointcut("execution(* org.opendelos.vodapp.services.structure.InstitutionService.saveCustomPeriod(..))")
	public void AfterInstitutionPeriodUpdated(){ }

	@Pointcut("execution(* org.opendelos.vodapp.services.structure.InstitutionService.deleteCustomPeriod(..))")
	public void AfterInstitutionPeriodDeleted(){ }

	@Pointcut("execution(* org.opendelos.vodapp.services.structure.InstitutionService.deleteCustomPause(..))")
	public void AfterInstitutionPauseDeleted(){ }

	/* Department CalendarUpdates */

	@Pointcut("execution(* org.opendelos.vodapp.services.structure.DepartmentService.saveCustomPause(..))")
	public void AfterDepartmentPauseUpdated(){ }

	@Pointcut("execution(* org.opendelos.vodapp.services.structure.DepartmentService.saveCustomPeriod(..))")
	public void AfterDepartmentPeriodUpdated(){ }

	@Pointcut("execution(* org.opendelos.vodapp.services.structure.DepartmentService.deleteCustomPeriod(..))")
	public void AfterDepartmentPeriodDeleted(){ }

	@Pointcut("execution(* org.opendelos.vodapp.services.structure.DepartmentService.deleteCustomPause(..))")
	public void AfterDepartmentPauseDeleted(){ }

	/* StudyProgram CalendarUpdates */

	@Pointcut("execution(* org.opendelos.vodapp.services.structure.StudyProgramService.saveCustomPeriod(..))")
	public void AfterStudyProgramPeriodUpdated(){ }

	@Pointcut("execution(* org.opendelos.vodapp.services.structure.StudyProgramService.deleteCustomPeriod(..))")
