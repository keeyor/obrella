/* 
     ...
     live
*/
package org.opendelos.vodapp.api.system;

import org.opendelos.model.system.SystemText;
import org.opendelos.vodapp.services.system.SystemTextService;
...
public class SystemTextsApi {
	...
	@RequestMapping(value="/apiw/v1/text/{site}/code/{code}",method = RequestMethod.GET)
	...
	@RequestMapping(value = "/apiw/v1/text/save/{site}/code/{code}", method = RequestMethod.POST, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/apiw/v1/text/delete/{id}", method = RequestMethod.DELETE)
