...
public class LiveChannelApi {
	...
	public List<ChannelProgram> SearchTimeTableByEditor() {
		...
		for (ScheduleDTO scheduleDTO : scheduleDTOList) {
			...
			LocalDateTime program_endTime = program_startTime.plus(scheduleDTO.getDurationHours(), ChronoUnit.HOURS)
					.plus(scheduleDTO.getDurationMinutes(), ChronoUnit.MINUTES);
