...
public class OdSimpleUrlAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
    ...
    protected void handle(HttpServletRequest request, HttpServletResponse response, Authentication authentication)
        ...
        //redirectStrategy.sendRedirect(request, response, targetUrl); // to avoid chrome security warning, use below static url! for now at least!
        //redirectStrategy.sendRedirect(request, response, "https://dimos.med.uoa.gr/dmms/");
