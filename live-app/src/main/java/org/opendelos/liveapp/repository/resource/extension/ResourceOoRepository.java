/* 
     ...
     OpenDelosDAC
*/
package org.opendelos.liveapp.repository.resource.extension;
...
public interface ResourceOoRepository {
     ...
     List<Resource> findRelatedPartsById(String id, String accessPolicy);

     long CountPublicResourcesByType(String type);

     long CountCollectionDocuments(String collectionName);

     Resource findParentResource(String classroomId, Instant date);
