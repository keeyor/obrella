package org.opendelos.liveapp.services.wowza;
...
public class WowzaRestService {
	...
	@Autowired
	public WowzaRestService(ClassroomService classroomService, StreamingServerService streamingServerService, LiveService liveService) {
	...
	public void STREAM_START(Resource resource, StreamingServer streamingServer) {
		...
		catch (RestClientException rce1) {
			logger.error("Error starting stream " + streamName + ". Error Message:" + rce1.getMessage());
		}
		try {
