...
import org.opendelos.liveapp.services.upload.SlideAnalysisDto;
...
public class ResourceService {
    ...
    @Autowired
    public ResourceService(ResourceRepository resourceRepository, OpUserService opUserService, MultimediaProperties multimediaProperties, StreamingProperties streamingProperties, ResourceUtils resourceUtils) {
    ...
    public List<Resource> findRelatedPartsById(String id, String accessPolicy) {
        return resourceRepository.findRelatedPartsById(id, accessPolicy);
    }

    public Resource findParentResource(String classroomId, Instant date) {
        return resourceRepository.findParentResource(classroomId,date);
    }
    ...
    public void removeResourceMultimedia(Resource resource) throws Exception {
        ...
        try {
            ...
            if (folder != null) {   //!Important: be very careful or might delete entire vl dir
                ...
                logger.info("DELETE video file:" + video_file);
                ...
                logger.info("DELETE thumb file:" + thumb_file);
