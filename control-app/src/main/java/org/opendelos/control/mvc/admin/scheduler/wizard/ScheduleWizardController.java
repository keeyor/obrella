/* 
     ...
     live
*/
package org.opendelos.control.mvc.admin.scheduler.wizard;
...
import org.opendelos.control.mvc.admin.scheduler.ScheduleRegistrationValidator;
...
public class ScheduleWizardController {
	...
	@GetMapping(value = {"admin/scheduler/wizard", "admin/scheduler/wizard/"})
	public String ScheduleEditor(final Model model, @RequestParam(value = "id",  required = false) String id,
		...
		return "admin/scheduler/wizard";
	}

	@PostMapping(value = {"admin/scheduler/wizard" ,"admin/scheduler/wizard/"})
