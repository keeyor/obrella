...
public class StreamingPropertiesConfig {
	...
	@Value( "${streaming.allow.regular.overlaps}")
	private boolean allowRegularOverlaps;
	@Value( "${streaming.allow.onetime.overlaps}")
	...
	public StreamingProperties streamingProperties() {
		...
		streamingProperties.setAllowRegularOverlaps(allowRegularOverlaps);
		streamingProperties.setAllowOnetimeOverlaps(allowOnetimeOverlaps);
