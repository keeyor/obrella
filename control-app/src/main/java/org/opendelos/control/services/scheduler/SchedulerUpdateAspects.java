/* 
     ...
     live
*/
package org.opendelos.control.services.scheduler;
...
public class SchedulerUpdateAspects {
	...
	private static final Logger actionLogger = LoggerFactory.getLogger("schedulerLogger");
	...
	@Pointcut("execution(* org.opendelos.control.services.scheduler.ScheduleService.create(..))  && " +  "args(schedule)")
	public void AfterNewScheduleCreated(Schedule schedule){ }

	@Pointcut("execution(* org.opendelos.control.services.scheduler.ScheduleService.update(..))  && " +  "args(schedule)")
	public void AfterSchedulerUpdated(Schedule schedule){ }

	@Pointcut("execution(* org.opendelos.control.services.scheduler.ScheduleService.delete(..))  && " +  "args(id)")
	public void AfterSchedulerDeleted(String id){ }

	@Pointcut("execution(* org.opendelos.control.services.structure.ClassroomService.findAndUpdate(..))  && " +  "args(classroom)")
	public void AfterClassroomUpdated(Classroom classroom){ }

	/* Institution CalendarUpdates */

	@Pointcut("execution(* org.opendelos.control.services.structure.InstitutionService.saveCustomPause(..))")
	public void AfterInstitutionPauseUpdated(){ }

	@Pointcut("execution(* org.opendelos.control.services.structure.InstitutionService.saveCustomPeriod(..))")
	public void AfterInstitutionPeriodUpdated(){ }

	@Pointcut("execution(* org.opendelos.control.services.structure.InstitutionService.deleteCustomPeriod(..))")
	public void AfterInstitutionPeriodDeleted(){ }

	@Pointcut("execution(* org.opendelos.control.services.structure.InstitutionService.deleteCustomPause(..))")
	public void AfterInstitutionPauseDeleted(){ }

	/* Department CalendarUpdates */

	@Pointcut("execution(* org.opendelos.control.services.structure.DepartmentService.saveCustomPause(..))")
	public void AfterDepartmentPauseUpdated(){ }

	@Pointcut("execution(* org.opendelos.control.services.structure.DepartmentService.saveCustomPeriod(..))")
	public void AfterDepartmentPeriodUpdated(){ }

	@Pointcut("execution(* org.opendelos.control.services.structure.DepartmentService.deleteCustomPeriod(..))")
	public void AfterDepartmentPeriodDeleted(){ }

	@Pointcut("execution(* org.opendelos.control.services.structure.DepartmentService.deleteCustomPause(..))")
	public void AfterDepartmentPauseDeleted(){ }

	/* StudyProgram CalendarUpdates */

	@Pointcut("execution(* org.opendelos.control.services.structure.StudyProgramService.saveCustomPeriod(..))")
	public void AfterStudyProgramPeriodUpdated(){ }

	@Pointcut("execution(* org.opendelos.control.services.structure.StudyProgramService.deleteCustomPeriod(..))")
	...
	public void UpdateTodaysScheduleForCreateWithConstrains(Schedule schedule){
		...
		this.LogAction2SchedulerLog("NEW", schedule);
	...
	public void UpdateTodaysScheduleForUpdateWithConstrains(Schedule schedule){
		...
		this.LogAction2SchedulerLog("UPDATE",schedule);
	}
	...
	public void UpdateTodaysScheduleForDelete(String id){
		...
		this.LogAction2SchedulerLog("DELETE",id);
	}
	...
	private void LogAction2SchedulerLog(String action,Schedule schedule) {

		OoUserDetails editor = (OoUserDetails) SecurityContextHolder.getContext().getAuthentication().getPrincipal();

		StringBuilder log_entry = new StringBuilder();
		if (editor != null) {
			log_entry.append("Action=").append(action).append(", Name=").append(editor.getName()).append(", uid=")
					.append(editor.getUid());
		}
		else {
			log_entry.append("Action=").append(action).append(", Name=").append("Uknown").append( ", uid=").append("Uknown");
		}
		log_entry.append(", Properties=").append("id:").append(schedule.getId()).append(",type:").append(schedule.getType()).append(",classroom:").append(schedule.getClassroom());
		if (schedule.getType().equals("regular")) {
				log_entry.append(",day:").append(schedule.getDayOfWeek()).append(",startime:").append(schedule.getStartTime());
		}
		else {
				log_entry.append(",date:").append(schedule.getDate()).append(",startime:").append(schedule.getStartTime());
		}
		actionLogger.info(log_entry.toString());
	}

	public void LogAction2SchedulerLog(String action, String id) {

		OoUserDetails editor = (OoUserDetails) SecurityContextHolder.getContext().getAuthentication().getPrincipal();

		StringBuilder log_entry = new StringBuilder();
		if (editor != null) {
			log_entry.append("Action=").append(action).append(", Name=").append(editor.getName()).append(", uid=").append(editor.getUid()).append(", Properties=").append("id:").append(id);
		}
		else {
			log_entry.append("Action=").append(action).append(", Name=").append("Uknown").append(", uid=").append("Unknown").append(", Properties=").append("id:").append(id);
		}
		actionLogger.info(log_entry.toString());
	}
