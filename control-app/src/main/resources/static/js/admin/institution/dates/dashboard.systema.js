...
(function () {
    ...
    function RegisterListeners() {
        ...
        $("#department-argies-edit").on('click',function(e){
            ...
            dashboard.modala.initDataTable( dashboard.selected_year, dashboard.institution,$department_s2.select2('data')[0].id);
            $("#modal_p_year").html(" " + dashboard.selected_year + "-" + (parseInt(dashboard.selected_year)+1));
            ...
            $("#modal_p_department_title").html("<b>" + $department_s2.select2('data')[0].text +"</b>");
