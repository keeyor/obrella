(function () {
    ...
    dashboard.staffmembers.loadStaffByReport = function (department_filter) {
        ...
        $.ajax({
            ...
            success: function (data) {
                $.each(data.data, function (index, element) {
                    let html = '<li class="list-group-item"><a class="text-dark text-decoration-none filter-item" href="#" data-filter="staff" data-target="' + element.id + '">' + element.name + '</a></li>';
