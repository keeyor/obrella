        ...
        coursesDT = $courses_dt_el.DataTable({
            ...
            "initComplete": function() {
                if (courseId !== '') {
                    ...
                    queryParams.delete("s");
                    $("#clear-co-filter").attr('href','live?' + queryParams);
                    $("#course-filter").show();
                }
                else {
        ...
        coursesDT = $courses_dt_el.DataTable({
            ...
            "aoColumnDefs": [
                ...
                },
                {
                    ...
                    "mRender": function (data,type,row) {
                        ...
                        queryParams.set("c", courseDtId);
                        queryParams.delete("skip");
                        return '<a style="color: #005cbf" href="live?' + queryParams + '">' + data +'</a>';
                    }
                },
                {
                    "aTargets": [3],
            ...
            "initComplete": function() {
                if ( this.api().data().length === 0) {
                    ...
                    queryParams.delete("skip");
                    let _html = '<tr>';
                    _html += '<td style="width: 92%" class="pl-0"><a href="live?' + queryParams + '">Διάλεξη</a></td>';
