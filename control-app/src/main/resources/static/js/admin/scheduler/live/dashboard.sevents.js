        ...
        $.ajax({
            ...
            success: function (data) {
                $.each(data.results, function (index, el) {
                    ...
                    $('#events-list').append('<li><a class="dropdown-item text-wrap" href="live?' + queryParams + '">' + el.text +'</a></li>');
                });
            }
        });
    ...
    dashboard.sevents.loadEventsByReport = function () {
        ...
        let eventsDT = $events_dt_el.DataTable({
            ...
            "aoColumnDefs": [
                ...
                },
                {
                    ...
                    "mRender": function (data,type,row) {
                        ...
                        return '<a class="" style="color: #005cbf" href="live?' + queryParams + '">' + data + '</a>';
                    }
                },
                {
                    "aTargets": [2],
            ...
            "initComplete": function() {
                ...
                queryParams.delete("skip");
                let _html =  '<tr>';
                _html += '<td style="width: 92%" class="pl-0"><a href="live?' + queryParams + '">Εκδήλωση</a></td>';
